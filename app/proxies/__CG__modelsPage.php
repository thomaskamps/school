 ...
 */
class Page extends \models\Page implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = array('title' => NULL, 'slug' => NULL, 'intro' => NULL, 'path' => NULL, 'path2' => NULL, 'subpage' => NULL, 'text' => NULL, 'view_status' => NULL, 'sort' => NULL, 'chg_date' => NULL);
    ...
    {
        unset($this->title, $this->slug, $this->intro, $this->path, $this->path2, $this->subpage, $this->text, $this->view_status, $this->sort, $this->chg_date);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'title', 'slug', 'intro', '' . "\0" . 'models\\Page' . "\0" . 'file', 'path', 'path2', 'subpage', 'text', 'view_status', 'sort', '' . "\0" . 'models\\Page' . "\0" . 'album', '' . "\0" . 'models\\Page' . "\0" . 'sidebar', 'pub_date', 'chg_date');
        }

        return array('__isInitialized__', 'id', '' . "\0" . 'models\\Page' . "\0" . 'file', '' . "\0" . 'models\\Page' . "\0" . 'album', '' . "\0" . 'models\\Page' . "\0" . 'sidebar', 'pub_date');
    }
     ...
     * {@inheritDoc}
     */
    public function addAlbum(\models\Album $album)
    {
     ...
     * {@inheritDoc}
     */
    public function removeAlbum(\models\Album $album)
    {
     ...
     * {@inheritDoc}
     */
    public function setSidebar(\models\Sidebar $sidebar = NULL)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSidebar', array($sidebar));

        return parent::setSidebar($sidebar);
    }
    ...
    public function getSidebar()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSidebar', array());

        return parent::getSidebar();
    }
    ...
    public function setPath2($path2)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPath2', array($path2));
