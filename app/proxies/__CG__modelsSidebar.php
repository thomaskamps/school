 ...
 */
class Sidebar extends \models\Sidebar implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = array('title' => NULL, 'text' => NULL, 'view_status' => NULL, 'chg_date' => NULL, 'path' => NULL);
    ...
    {
        unset($this->title, $this->text, $this->view_status, $this->chg_date, $this->path);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'title', 'text', 'view_status', 'pub_date', 'chg_date', 'page', '' . "\0" . 'models\\Sidebar' . "\0" . 'file', 'path');
        }

        return array('__isInitialized__', 'id', 'pub_date', 'page', '' . "\0" . 'models\\Sidebar' . "\0" . 'file');
    }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Sidebar $proxy) {
